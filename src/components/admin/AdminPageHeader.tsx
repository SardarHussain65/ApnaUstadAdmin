...
export function AdminPageHeader({
  ...
  return (
    <div className="relative overflow-hidden rounded-[24px] border border-white/10 bg-[linear-gradient(135deg,rgba(15,15,30,0.96),rgba(10,10,24,0.92))] p-5 shadow-[0_20px_60px_rgba(0,0,0,0.35)] sm:p-6">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_100%_0%,rgba(0,245,255,0.12),transparent_42%),radial-gradient(circle_at_0%_100%,rgba(191,90,242,0.1),transparent_40%)]" />
      ...
      <div className="relative flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
        <div className="min-w-0">
          ...
          <h2 className="text-2xl font-extrabold tracking-[-0.03em] text-white sm:text-[2rem]">{title}</h2>
      ...
      {stats && (
        <div className="relative mt-5 border-t border-white/8 pt-5">{stats}</div>
      )}
    </div>
  );
}
